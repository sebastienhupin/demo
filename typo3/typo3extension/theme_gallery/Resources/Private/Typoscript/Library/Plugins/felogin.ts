...
#############################################
# PLUG-IN felogin box
plugin.tx_felogin_pi1.templateFile = EXT:theme_gallery/Resources/Private/Templates/Theme/Plugins/FeLogin/felogin.html
...
plugin.tx_felogin_pi1 {
  ...
  # En cas d'erreur on active la modal via une action jQuery
